...
<div class="md:h-5/6 lg:h-2/3 px-0 md:px-8 bg-gradient-to-l from-teal-200">
	<div
		use:scrollRef={'hero'}
	...
	>
		...
		>
			...
			<div class="text-2xl md:text-4xl pt-4 font-light">
				Mobile and web development at its finest.
			</div>
			<div class="flex flex-row justify-center lg:justify-start space-x-2 py-4 md:py-8">
				<div class="text-small bg-teal-500 p-0.5 px-4 rounded-full">sachinda.yl@gmail.com</div>
		...
		<div
			class="animate__animated animate__fadeInRight flex-none flex flex-col md:flex-row lg:flex-col md:justify-center w-full md:w-20 mt-20 mb-8 lg:mb-0 lg:mt-0 items-center lg:items-end"
		>
			<div class="px-4">
				<div class="text-2xl lg:text-4xl text-center lg:text-end font-semibold">6+</div>
				<div class="text-xl lg:text-2xl text-center lg:text-end font-light">
					Years of experience
				</div>
			</div>
			<div class="px-4">
				<div class="text-2xl lg:text-4xl text-center lg:text-end pt-8 md:pt-0 lg:pt-16 font-semibold">
					20+
				</div>
				<div class="text-xl lg:text-2xl text-center lg:text-end font-light">Projects done</div>
			</div>
		</div>
	</div>
</div>
